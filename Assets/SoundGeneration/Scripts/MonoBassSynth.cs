...
public class MonoBassSynth : MonoBehaviour
{
    ...
    public void NoteOn(int midi, float vel, float sustainBeats, float secPerBeat)
    {
    ...
    {
        double srD = sr;
        double invSR = 1.0 / srD;
        double blockStart = AudioSettings.dspTime;
        dspCursor = blockStart;
        ...
        {
            // timing (no UnityEngine.Time on audio thread)
            dspCursor += invSR;
